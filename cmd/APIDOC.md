...
Package cmd 提供命令行标志管理功能。

## VARIABLES

### ChineseTemplate
中文模板实例，定义命令行工具的中文帮助信息格式。
