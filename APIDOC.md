...
ParseFlagsOnly 仅解析当前命令的标志参数（忽略子命令）。主要功能包括：
...
type QCommandLineInterface interface {
	...
	Uint32(longName, shortName string, defValue uint32, usage string) *flags.Uint32Flag
	Uint64(longName, shortName string, defValue uint64, usage string) *flags.Uint64Flag
	IP4(longName, shortName string, defValue string, usage string) *flags.IP4Flag
	IP6(longName, shortName string, defValue string, usage string) *flags.IP6Flag
	URL(longName, shortName string, defValue string, usage string) *flags.URLFlag
	...
	Uint32Var(f *flags.Uint32Flag, longName, shortName string, defValue uint32, usage string)
	Uint64Var(f *flags.Uint64Flag, longName, shortName string, defValue uint64, usage string)
	IP4Var(f *flags.IP4Flag, longName, shortName string, defValue string, usage string)
	IP6Var(f *flags.IP6Flag, longName, shortName string, defValue string, usage string)
	URLVar(f *flags.URLFlag, longName, shortName string, defValue string, usage string)
}
```
